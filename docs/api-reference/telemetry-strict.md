...
- `valid`: flag indicating whether the data is considered valid. If the data is not valid it will be discarded later in the pipeline. It will have a value of 1 if valid and 0 if not.
